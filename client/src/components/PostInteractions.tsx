      ...
      <div className="flex items-center gap-6 flex-1">
        ...
        <div className="flex items-center gap-1 cursor-pointer group">
          ...
          >
            <path
              className={` ${
                isRePosted ? "fill-green-700" : "fill-textGray"
          ...
          <span
            className={`${
              isRePosted ? "text-green-700" : "text-grey"
        ...
        <div className="flex items-center gap-1 cursor-pointer group">
          ...
          >
            <path
              className={` ${
                isLiked ? "fill-red-700" : "fill-textGray"
          ...
          <span
            className={`${
              isLiked ? "text-red-700" : "text-grey"
      ...
      <div className="flex items-center gap-1">
        <div className="cursor-pointer group">
          ...
          >
            <path
              className={`${
                isSaved ? "fill-secondary-700" : "text-grey"
              }group-hover:fill-secondary-700 text-sm`}
