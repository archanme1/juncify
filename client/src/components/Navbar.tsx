...
const Navbar = () => {
  ...
  const isDashboardPage =
    pathname.includes("/managers") || pathname.includes("/customers");
      ...
      <div className="flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white">
        <div className="flex items-center gap-4 md:gap-6">
          ...
          {/* {isDashboardPage && authUser && (
            <Button
              variant="secondary"
              className="md:ml-4 bg-primary-50 text-primary-700 hover:bg-secondary-7  00 hover:text-primary-50"
              onClick={() =>
                router.push(
        ...
        <div className="flex items-center gap-5">
          {authUser ? (
            <>
              {/* CAN UPDATE TO NOTIFICATION AND MESSAGE LATER ON  */}
