...
-- CreateIndex
CREATE UNIQUE INDEX "User_managerCognitoId_key" ON "User"("managerCognitoId");

-- CreateIndex
CREATE UNIQUE INDEX "User_customerCognitoId_key" ON "User"("customerCognitoId");

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_managerCognitoId_fkey" FOREIGN KEY ("managerCognitoId") REFERENCES "Manager"("cognitoId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_customerCognitoId_fkey" FOREIGN KEY ("customerCognitoId") REFERENCES "Customer"("cognitoId") ON DELETE SET NULL ON UPDATE CASCADE;
